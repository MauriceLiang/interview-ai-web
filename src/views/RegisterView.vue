    ...
    <div class="auth-main">
      <el-card class="auth-card">
        <div class="auth-header">
          ...
          <p class="auth-subtitle">开启你的 AI 模拟面试之旅</p>
        </div>

        <el-form @submit.prevent="onRegister" class="auth-form">
          ...
          <el-form-item v-if="err" class="form-item-in" style="animation-delay:0.16s">
            <el-alert :title="err" type="error" show-icon :closable="false" />
          </el-form-item>
          <el-form-item class="form-item-in" style="animation-delay:0.18s">
            <el-button type="primary" size="large" class="login-btn" @click="onRegister" :loading="loading">
              注 册
            </el-button>
          </el-form-item>
        </el-form>
